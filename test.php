...
$featurearray = array("Crime" => array("Disturbing the peace","Petty theft","Defacing church property","Defacing government property","Forging a check","Driving under the influence","Selling marijuana","Donating to a radical organization","Sale of counterfeit goods"),"Race/Ethnicity" => array("White","Black","Hispanic/Latino","Asian","Muslim"),"Citizenship" => array("Citizen","Non-citizen","Unknown"),"Gender" => array("Male","Female"),"Age" => array("Early 20s","Mid-forties","Over 60"),"Physical Description" => array("Head was covered","No specific identifiers"));
